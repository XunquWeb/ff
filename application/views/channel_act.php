...
<html lang="zh-CN">
  <head>
    ...
    <link href="<?php echo base_url('css/channel_act.css')?>" rel="stylesheet">
      ...
      <div id="carousel-channel-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="<?php echo base_url('image/example1.jpeg')?>" alt="...">
          </div>
          <div class="item">
            <img src="<?php echo base_url('image/example2.jpeg')?>" alt="...">
          </div>
          <div class="item">
            <img src="<?php echo base_url('image/example3.jpeg')?>" alt="...">
          </div>
        </div>
      ...
      <div id="board">
        <a href="<?php echo base_url('Act/display/0')?>" class="b_item">
          <i class="b_icon"></i>
          <div class="fl">
            <p>全部约单</p>
            <span>总有新奇在身边</span>
        ...
        <a href="<?php echo base_url('Forum/public_forum')?>" class="b_item">
          <i class="b_icon"></i>
          <div class="fl">
            <p>广场趣谈</p>
            <span>大家一起来吐槽</span>
