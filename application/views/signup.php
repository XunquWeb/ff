...
<form action="<?=base_url('User/signup')?>" class="form-signin" method="post" accept-charset="utf-8">
                ...
                <a href="<?=base_url('User/login')?>" class="text-center new-account">已有账号，点此登陆</a>
            </div>
        </div>
